...
!! | GFS_Data(cdata%blk_no)%Tbd%raincprv                         | lwe_thickness_of_convective_precipitation_amount_from_previous_timestep                        | convective_precipitation_amount from previous timestep  | m             |    1 | real    | kind_phys | none   | F        |
!! | GFS_Data(cdata%blk_no)%Tbd%rainncprv                        | lwe_thickness_of_explicit_rainfall_amount_from_previous_timestep                               | explicit rainfall from previous timestep                | m             |    1 | real    | kind_phys | none   | F        |
