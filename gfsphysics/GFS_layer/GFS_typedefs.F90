...
!! | GFS_Data(cdata%blk_no)%Sfcprop%ffmm        | Monin_Obukhov_similarity_function_for_momentum                         | Monin-Obukhov similarity function for momentum         | none          |    1 | real    | kind_phys | none   | F        |
!! | GFS_Data(cdata%blk_no)%Sfcprop%ffhh        | Monin_Obukhov_similarity_function_for_heat                             | Monin-Obukhov similarity function for heat             | none          |    1 | real    | kind_phys | none   | F        |
...
!! | GFS_Data(cdata%blk_no)%Sfcprop%z_c         | sub_layer_cooling_thickness                                            | sub-layer cooling thickness                            | m             |    1 | real    | kind_phys | none   | F        |
...
!! | GFS_Data(cdata%blk_no)%Sfcprop%dt_cool     | sub_layer_cooling_amount                                               | sub-layer cooling amount                               | K             |    1 | real    | kind_phys | none   | F        |
...
!! | GFS_Control%iovr_sw                  | flag_for_max_random_overlap_clouds_for_shortwave_radiation                    | sw: max-random overlap clouds                           | flag          |    0 | integer   |           | none   | F        |
!! | GFS_Control%iovr_lw                  | flag_for_max_random_overlap_clouds_for_longwave_radiation                     | lw: max-random overlap clouds                           | flag          |    0 | integer   |           | none   | F        |
!! | GFS_Control%ictm                     | flag_for_initial_time_date_control                                            | flag for initial conditions and forcing                 | flag          |    0 | integer   |           | none   | F        |
!! | GFS_Control%isubc_sw                 | flag_for_sw_clouds_without_sub_grid_approximation                             | flag for sw clouds without sub-grid approximation       | flag          |    0 | integer   |           | none   | F        |
!! | GFS_Control%isubc_lw                 | flag_for_lw_clouds_without_sub_grid_approximation                             | flag for lw clouds without sub-grid approximation       | flag          |    0 | integer   |           | none   | F        |
!! | GFS_Control%crick_proof              | flag_for_CRICK_proof_cloud_water                                              | flag for CRICK-Proof cloud water                        | flag          |    0 | logical   |           | none   | F        |
...
!! | GFS_Control%npdf3d                   | number_of_3d_arrays_associated_with_pdf_based_clouds                          | number of 3d arrays associated with pdf based clouds/mp              | count         |    0 | integer   |           | none   | F        |
...
!! | GFS_Data(cdata%blk_no)%Intdiag%wetdpl               | instantaneous_large_scale_wet_deposition                                  | instantaneous large-scale wet deposition                               | kg m-2 s-1    |    2 | real        | kind_phys | none   | F        |
!! | GFS_Data(cdata%blk_no)%Intdiag%wetdpc               | instantaneous_convective_scale_wet_deposition                             | instantaneous convective-scale wet deposition                          | kg m-2 s-1    |    2 | real        | kind_phys | none   | F        |
...
!! | GFS_Interstitial(cdata%thrd_no)%faerlw                        | aerosol_optical_properties_for_longwave_bands_01_16                                            | aerosol optical properties for longwave bands 01-16                                 | various       |    4 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faerlw(:,:,:,1)               | aerosol_optical_depth_for_longwave_bands_01_16                                                 | aerosol optical depth for longwave bands 01-16                                      | none          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faerlw(:,:,:,2)               | aerosol_single_scattering_albedo_for_longwave_bands_01_16                                      | aerosol single scattering albedo for longwave bands 01-16                           | frac          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faerlw(:,:,:,3)               | aerosol_asymmetry_parameter_for_longwave_bands_01_16                                           | aerosol asymmetry parameter for longwave bands 01-16                                | none          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faersw                        | aerosol_optical_properties_for_shortwave_bands_01_16                                           | aerosol optical properties for shortwave bands 01-16                                | various       |    4 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faersw(:,:,:,1)               | aerosol_optical_depth_for_shortwave_bands_01_16                                                | aerosol optical depth for shortwave bands 01-16                                     | none          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faersw(:,:,:,2)               | aerosol_single_scattering_albedo_for_shortwave_bands_01_16                                     | aerosol single scattering albedo for shortwave bands 01-16                          | frac          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%faersw(:,:,:,3)               | aerosol_asymmetry_parameter_for_shortwave_bands_01_16                                          | aerosol asymmetry parameter for shortwave bands 01-16                               | none          |    3 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%ffhh_ocean                    | Monin_Obukhov_similarity_function_for_heat_over_ocean                                          | Monin-Obukhov similarity function for heat over ocean                               | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%ffhh_land                     | Monin_Obukhov_similarity_function_for_heat_over_land                                           | Monin-Obukhov similarity function for heat over land                                | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%ffhh_ice                      | Monin_Obukhov_similarity_function_for_heat_over_ice                                            | Monin-Obukhov similarity function for heat over ice                                 | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fh2                           | Monin_Obukhov_similarity_function_for_heat_at_2m                                               | Monin-Obukhov similarity parameter for heat at 2m                                   | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fh2_ocean                     | Monin_Obukhov_similarity_function_for_heat_at_2m_over_ocean                                    | Monin-Obukhov similarity parameter for heat at 2m over ocean                        | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fh2_land                      | Monin_Obukhov_similarity_function_for_heat_at_2m_over_land                                     | Monin-Obukhov similarity parameter for heat at 2m over land                         | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fh2_ice                       | Monin_Obukhov_similarity_function_for_heat_at_2m_over_ice                                      | Monin-Obukhov similarity parameter for heat at 2m over ice                          | none          |    1 | real        | kind_phys | none   | F        |
...
!! | GFS_Interstitial(cdata%thrd_no)%ffmm_ocean                    | Monin_Obukhov_similarity_function_for_momentum_over_ocean                                      | Monin-Obukhov similarity function for momentum over ocean                           | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%ffmm_land                     | Monin_Obukhov_similarity_function_for_momentum_over_land                                       | Monin-Obukhov similarity function for momentum over land                            | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%ffmm_ice                      | Monin_Obukhov_similarity_function_for_momentum_over_ice                                        | Monin-Obukhov similarity function for momentum over ice                             | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fm10                          | Monin_Obukhov_similarity_function_for_momentum_at_10m                                          | Monin-Obukhov similarity parameter for momentum at 10m                              | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fm10_ocean                    | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_ocean                               | Monin-Obukhov similarity parameter for momentum at 10m over ocean                   | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fm10_land                     | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_land                                | Monin-Obukhov similarity parameter for momentum at 10m over land                    | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%fm10_ice                      | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_ice                                 | Monin-Obukhov similarity parameter for momentum at 10m over ice                     | none          |    1 | real        | kind_phys | none   | F        |
...
!! | GFS_Interstitial(cdata%thrd_no)%work1                         | grid_size_related_coefficient_used_in_scale_sensitive_schemes                                  | grid size related coefficient used in scale-sensitive schemes                       | none          |    1 | real        | kind_phys | none   | F        |
!! | GFS_Interstitial(cdata%thrd_no)%work2                         | grid_size_related_coefficient_used_in_scale_sensitive_schemes_complement                       | complement to work1                                                                 | none          |    1 | real        | kind_phys | none   | F        |
