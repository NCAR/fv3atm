...
!JLS    logical,               pointer      :: otspt(:,:)       => null()  !<  ! JLS Issue with dimensions (tottracer+3,2)
    integer                             :: oz_coeff                    !<
...
!JLS    allocate (Interstitial%otspt      (Model%ntr,2))
...
!JLS    write (0,*) 'Interstitial%otspt             = ', Interstitial%otspt(1,1)      )
