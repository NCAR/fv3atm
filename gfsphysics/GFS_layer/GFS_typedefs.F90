...
!! | IPD_Interstitial(nt)%rainst                        | lwe_thickness_of_stratiform_precipitation_amount_on_dynamics_timestep                          | stratiform rainfall amount on physics timestep                                      | m             |    1 | real        | kind_phys | none   | F        |
