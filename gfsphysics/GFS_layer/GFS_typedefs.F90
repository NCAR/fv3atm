...
!! | IPD_Data(nb)%Statein%qgrs(:,:,IPD_Control%ntoz) | ozone_mixing_ratio                                        | ozone mixing ratio                                                                  | kg kg-1       |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Statein%qgrs(:,:,IPD_Control%ntke) | turbulent_kinetic_energy                                  | turbulent kinetic energy                                                            | J             |    2 | real    | kind_phys | none   | F        |
!! | IPD_Data(nb)%Statein%diss_est                   | dissipation_estimate_of_air_temperature_at_model_layers   | dissipation estimate model layer mean temperature                                   | K             |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Sfcprop%keepsmfr    | volume_fraction_of_frozen_soil_moisture_for_land_surface_model         | volume fraction of frozen soil moisture for lsm        | frac          |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Sfcprop%qwv_surf    | water_vapor_mixing_ratio_at_surface                                    | water vapor mixing ratio at surface                    | kg kg-1       |    1 | real    | kind_phys | none   | F        |
...
!! | IPD_Control%logunit                  | iounit_log                                                                    | fortran unit number for logfile                         | none          |    0 | integer   |           | none   | F        |
...
!! | IPD_Control%lgocart                  | flag_gocart                                                                   | flag for 3d diagnostic fields for gocart 1              | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%blksz(nb)                | horizontal_loop_extent                                                        | horizontal loop extent (previously Interstitial(nt)%im) | count         |    0 | integer   |           | none   | F        |
!! | IPD_Control%blksz(nb)                | horizontal_dimension                                                          | horizontal dimension (previously Interstitial(nt)%ix)   | count         |    0 | integer   |           | none   | F        |
...
!! | IPD_Control%aero_in                  | flag_for_aerosol_input_MG                                                     | flag for using aerosols in Morrison-Gettelman microphysics | flag       |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%icliq_sw                 | flag_for_optical_property_for_liquid_clouds_for_shortwave_radiation           | sw optical property for liquid clouds                   | flag          |    0 | integer   |           | none   | F        |
...
!! | IPD_Control%fprcp                    | number_of_frozen_precipitation_species                                        | number of frozen precipitation species                  | count         |    0 | integer   |           | none   | F        |
!! | IPD_Control%pdfflag                  | flag_for_pdf_for_morrison_gettelman_microphysics_scheme                       | pdf flag for MG macrophysics                            | flag          |    0 | integer   |           | none   | F        |
!! | IPD_Control%mg_dcs                   | mg_autoconversion_size_threshold_ice_snow                                     | autoconversion size threshold for cloud ice to snow for MG microphysics       | um      |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_qcvar                 | mg_cloud_water_variance                                                       | cloud water relative variance for MG microphysics                             |         |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_ts_auto_ice           | mg_time_scale_for_autoconversion_of_ice                                       | autoconversion time scale for ice for MG microphysics                         | s       |    1 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_rhmini                | mg_minimum_rh_for_ice                                                         | relative humidity threshold parameter for nucleating ice for MG microphysics  | none    |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_ncnst                 | mg_drop_concentration_constant                                                | droplet concentration constant for MG microphysics                            | m-3     |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_ninst                 | mg_ice_concentration_constant                                                 | ice concentration constant for MG microphysics                                | m-3     |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_ngnst                 | mg_graupel_concentration_constant                                             | graupel concentration constant for MG microphysics                            | m-3     |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_berg_eff_factor       | mg_bergeron_efficiency_factor                                                 | bergeron efficiency factor for MG microphysics                                | frac    |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_alf                   | mg_tuning_factor_for_alphas                                                   | tuning factor for alphas (alpha = 1 - critical relative humidity)             | none    |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_qcmin                 | mg_minimum_cloud_condensed_water_and_ice_mixing_ratio                         | minimum cloud condensed water and ice mixing ratio in MG macro clouds         | kg kg-1 |    1 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_qcmin(1)              | mg_minimum_cloud_condensed_water_mixing_ratio                                 | minimum cloud condensed water mixing ratio in MG macro clouds                 | kg kg-1 |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_qcmin(2)              | mg_minimum_ice_mixing_ratio                                                   | minimum ice mixing ratio in MG macro clouds                                   | kg kg-1 |    0 | real       | kind_phys | none   | F        |
!! | IPD_Control%mg_precip_frac_method    | mg_type_of_precip_fraction_method                                             | type of precip fraction method for MG microphysics (in_cloud or max_overlap)  | none    |    0 | character  | len=16    | none   | F        |
!! | IPD_Control%tf                       | frozen_cloud_threshold_temperature                                            | threshold temperature below which all cloud is ice      | K             |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%tcr                      | cloud_phase_transition_threshold_temperature                                  | threshold temperature below which cloud starts to freeze| K             |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%tcrf                     | cloud_phase_transition_denominator                                            | denominator in cloud phase transition = 1/(tcr-tf)      | K-1           |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%effr_in                  |                                                                               | eg to turn on ffective radii for MG                     |               |    0 | logical   |           | none   | F        |
!! | IPD_Control%microp_uniform           | mg_flag_for_uniform_subcolumns                                                | flag for uniform subcolumns for MG microphysics         | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%do_cldliq                |                                                                               |                                                         |               |    0 | logical   |           | none   | F        |
!! | IPD_Control%do_cldice                | mg_flag_for_cloud_ice_processes                                               | flag for cloud ice processes for MG microphysics                  | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%hetfrz_classnuc          | mg_flag_for_heterogeneous_freezing                                            | flag for heterogeneous freezing for MG microphysics               | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_nccons                | mg_flag_drop_concentration_constant                                           | flag for constant droplet concentration for MG microphysics       | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_nicons                | mg_flag_ice_concentration_constant                                            | flag for constant ice concentration for MG microphysics           | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_ngcons                | mg_flag_graupel_concentration_constant                                        | flag for constant graupel concentration for MG microphysics       | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%sed_supersat             | mg_allow_supersat_after_sed                                                   | allow supersaturation after sedimentation for MG microphysics     | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%do_sb_physics            | mg_flag_for_sb2001_autoconversion                                             | flag for SB 2001 autoconversion or accretion for MG microphysics  | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_do_graupel            | mg_flag_for_graupel                                                           | flag for graupel for MG microphysics (hail possible if false)     | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_do_hail               | mg_flag_for_hail                                                              | flag for hail for MG microphysics (graupel possible if false)     | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_do_ice_gmao           | mg_flag_for_gmao_ice_formulation                                              | flag for gmao ice formulation                                     | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%mg_do_liq_liu            | mg_flag_for_liu_liquid_treatment                                              | flag for liu liquid treatment                                     | flag  |    0 | logical |           | none   | F        |
!! | IPD_Control%shoc_parm(1)             | shoc_tke_dissipatation_pressure_threshold                                     | pressure below which extra TKE diss. is applied in SHOC | Pa            |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%shoc_parm(2)             | shoc_tke_dissipation_tunable_parameter                                        | mult. tuning parameter for TKE diss. in SHOC            | none          |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%shoc_parm(3)             | shoc_tke_dissipation_tunable_parameter_near_surface                           | mult. tuning parameter for TKE diss. at surface in SHOC | none          |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%shoc_parm(4)             | shoc_implicit_TKE_integration_uncentering_term                                | uncentering term for TKE integration in SHOC            | none          |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%shoc_parm(5)             | shoc_flag_for_optional_surface_TKE_dissipation                                | flag for alt. TKE diss. near surface in SHOC (>0 = ON)  | none          |    0 | real      | kind_phys | none   | F        |
...
!! | IPD_Control%ras                      | flag_for_ras_deep_convection                                                  | flag for ras convection scheme                          | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%flipv                    | flag_flip                                                                     | vertical flip logical                                   | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%old_monin                | flag_for_old_PBL_scheme                                                       | flag for using old PBL schemes                          | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%cnvgwd                   | flag_convective_gravity_wave_drag                                             | flag for conv gravity wave drag                         | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%mstrat                   | flag_for_moorthi_stratus                                                      | flag for moorthi approach for stratus                   | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%shinhong                 | flag_for_scale_aware_Shinhong_PBL                                             | flag for scale-aware Shinhong PBL scheme                | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%do_ysu                   | flag_for_ysu                                                                  | flag for YSU PBL scheme                                 | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%do_awdd                  | flag_arakawa_wu_downdraft                                                     | AW scale-aware option in cs convection downdraft        | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%flx_form                 | flag_flux_form_CS                                                             | enable use of flux form of equations in CS scheme       | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%do_shoc                  | flag_for_shoc                                                                 | flag for SHOC                                           | flag          |    0 | logical   |           | none   | F        |
!! | IPD_Control%shocaftcnv               | flag_for_shoc_after_convection                                                | flag to execute SHOC after convection                   | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%hybedmf                  | flag_for_hedmf                                                                | flag for hybrid edmf pbl scheme (moninedmf)             | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%shal_cnv                 | flag_for_shallow_convection                                                   | flag for calling shallow convection                     | flag          |    0 | logical   |           | none   | F        |
...
!! | IPD_Control%cs_parm(1)               | updraft_velocity_tunable_parameter_1_CS                                       | tunable parameter 1 for Chikira-Sugiyama convection     | m s-1         |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%cs_parm(2)               | updraft_velocity_tunable_parameter_2_CS                                       | tunable parameter 2 for Chikira-Sugiyama convection     | m s-1         |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%cs_parm(3)               | detrainment_and_precipitation_tunable_parameter_3_CS   | partition water between detrainment and precipitation (decrease for more precipitation) | m    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%cs_parm(4)               | detrainment_and_precipitation_tunable_parameter_4_CS   | partition water between detrainment and precipitation (decrease for more precipitation) | m    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%cs_parm(9)               | entrainment_efficiency_tunable_parameter_9_CS                                 | entrainment efficiency                                  | none          |    0 | real      | kind_phys | none   | F        |
...
!! | IPD_Control%sup                      | ice_supersaturation_threshold                                                 | ice supersaturation parameter for PDF clouds            | none          |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%ctei_rm                  | critical_cloud_top_entrainment_instability_criteria                           | critical cloud top entrainment instability criteria     | none          |    1 | real      | kind_phys | none   | F        |
!! | IPD_Control%crtrh                    | critical_relative_humidity_at_sfc_pbltop_toa                                  | critical relative humidity at SFC, PBL top and TOA      | frac          |    1 | real      | kind_phys | none   | F        |
!! | IPD_Control%dlqf                     |                                                                               | factor for cloud condensate detrainment from cloud edges|               |    1 | real      | kind_phys | none   | F        |
!! | IPD_Control%psauras                  |                                                                               | auto conversion coeff from ice to snow in ras           |               |    1 | real      | kind_phys | none   | F        |
!! | IPD_Control%prauras                  |                                                                               | auto conversion coeff from cloud to rain in ras         |               |    1 | real      | kind_phys | none   | F        |
!! | IPD_Control%wminras                  |                                                                               | water and ice minimum threshold for ras                 |               |    1 | real      | kind_phys | none   | F        |
...
!! | IPD_Control%clam_deep                | entrainment_rate_coefficient_deep_convection                                  | entrainment rate coefficient for deep conv.                                          | none    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%c0s_deep                 | rain_conversion_parameter_deep_convection                                     | convective rain conversion parameter for deep conv.                                  | m-1     |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%c1_deep                  | detrainment_conversion_parameter_deep_convection                              | convective detrainment conversion parameter for deep conv.                           | m-1     |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%betal_deep               | downdraft_fraction_reaching_surface_over_land_deep_convection                 | downdraft fraction reaching surface over land for deep conv.                         | frac    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%betas_deep               | downdraft_fraction_reaching_surface_over_ocean_deep_convection                | downdraft fraction reaching surface over ocean for deep conv.                        | frac    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%evfact_deep              | rain_evaporation_coefficient_deep_convection                                  | convective rain evaporation coefficient for deep conv.                               | frac    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%evfactl_deep             | rain_evaporation_coefficient_over_land_deep_convection                        | convective rain evaporation coefficient over land for deep conv.                     | frac    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%pgcon_deep               | momentum_transport_reduction_factor_pgf_deep_convection                       | reduction factor in momentum transport due to deep conv. induced pressure gradient force  | frac    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%asolfac_deep             | aerosol_aware_parameter_deep_convection                                       | aerosol-aware parameter inversely proportional to CCN number concentraion from Lim (2011) for deep conv. | none    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%clam_shal                | entrainment_rate_coefficient_shallow_convection                               | entrainment rate coefficient for shal conv.                                                              | none    |    0 | real      | kind_phys | none   | F        |
!! | IPD_Control%c0s_shal                 | rain_conversion_parameter_shallow_convection                                  | convective rain conversion parameter for shal conv.                                                      | m-1     |    0 | real      | kind_phys | none   | F        |
...
!! | IPD_Control%ntke                     | index_for_turbulent_kinetic_energy                                            | tracer index for turbulent kinetic energy                            | index         |    0 | integer   |           | none   | F        |
...
!! | IPD_Control%indcld                   | index_for_cloud_fraction_in_3d_arrays_for_microphysics                        | index of cloud fraction in phyf3d (used only for SHOC or MG)         | index         |    0 | integer   |           | none   | F        |
...
!! | IPD_Control%nctp                     | number_of_cloud_types_CS                                                      | number of cloud types in Chikira-Sugiyama scheme                     | count         |    0 | integer   |           | none   | F        |
!! | IPD_Control%ncnvw                    |                                                                               | the index of cnvw in phy_f3d                                         |               |    0 | integer   |           | none   | F        |
!! | IPD_Control%ncnvc                    |                                                                               | the index of cnvc in phy_f3d                                         |               |    0 | integer   |           | none   | F        |
!! | IPD_Control%ngreffr                  | index_for_graupel_effective_radius                                            | the index of graupel effective radius in phy_f3d                     |               |    0 | integer   |           | none   | F        |
...
!! | IPD_Data(nb)%Tbd%in_nm                            | in_number_concentration                                                                        | IN number concentration                                 | kg-1?         |    2 | real    | kind_phys | none   | F        |
!! | IPD_Data(nb)%Tbd%ccn_nm                           | ccn_number_concentration                                                                       | CCN number concentration                                | kg-1?         |    2 | real    | kind_phys | none   | F        |
!! | IPD_Data(nb)%Tbd%aer_nm                           | aerosol_number_concentration_from_gocart_aerosol_climatology                                   | GOCART aerosol climatology number concentration         | kg-1?         |    3 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%dtdtr                            | tendency_of_air_temperature_due_to_radiative_heating_on_physics_time_step                      | temp. change due to radiative heating per time step     | K             |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%drain_cpl                        | tendency_of_lwe_thickness_of_precipitation_amount_for_coupling                                 | change in rain_cpl (coupling_type)                      | m             |    1 | real    | kind_phys | none   | F        |
!! | IPD_Data(nb)%Tbd%dsnow_cpl                        | tendency_of_lwe_thickness_of_snow_amount_for_coupling                                          | change in show_cpl (coupling_type)                      | m             |    1 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,1)                   | cloud_fraction_for_MG                                                                          | cloud fraction used by Morrison-Gettelman MP            | frac          |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,2)                   | effective_radius_of_stratiform_cloud_liquid_water_particle_in_um                               | eff. radius of cloud liquid water particle in micrometer| um            |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,3)                   | effective_radius_of_stratiform_cloud_ice_particle_in_um                                        | eff. radius of cloud ice water particle in micrometer   | um            |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,4)                   | effective_radius_of_stratiform_cloud_rain_particle_in_um                                       | effective radius of cloud rain particle in micrometers  | um            |    2 | real    | kind_phys | none   | F        |
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,5)                   | effective_radius_of_stratiform_cloud_snow_particle_in_um                                       | effective radius of cloud snow particle in micrometers  | um            |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,IPD_Control%ncnvc)   | convective_cloud_cover_in_phy_f3d                                                              | convective cloud cover in the phy_f3d array             | frac          |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Tbd%phy_f3d(:,:,IPD_Control%ngreffr) | effective_radius_of_stratiform_cloud_graupel_particle_in_um                                    | eff. radius of cloud graupel particle in micrometer     | um            |    2 | real    | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Radtend%lwhd                 | tendency_of_air_temperature_due_to_longwave_heating_for_idea                                  | idea sky lw heating rates                               | K s-1         |    3 | real        | kind_phys | none   | F        |
!!
#endif
...
!! | IPD_Data(nb)%Intdiag%dqsfc                | cumulative_surface_upward_latent_heat_flux_for_diag_multiplied_by_timestep       | cumulative sfc latent heat flux multiplied by timestep          | W m-2 s       |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%totice               | accumulated_lwe_thickness_of_ice_amount                                 | accumulated ice precipitation                                   | kg m-2        |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%totsnw               | accumulated_lwe_thickness_of_snow_amount                                | accumulated snow precipitation                                  | kg m-2        |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%totgrp               | accumulated_lwe_thickness_of_graupel_amount                             | accumulated graupel precipitation                               | kg m-2        |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%totprcpb             | accumulated_lwe_thickness_of_precipitation_amount_in_bucket             | accumulated total precipitation in bucket                       | m             |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%dlwsfc               | cumulative_surface_downwelling_longwave_flux_multiplied_by_timestep     | cumulative surface downwelling LW flux multiplied by timestep   | W m-2 s       |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%ulwsfc               | cumulative_surface_upwelling_longwave_flux_multiplied_by_timestep       | cumulative surface upwelling LW flux multiplied by timestep     | W m-2 s       |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%suntim               | duration_of_sunshine                                                    | sunshine duration time                                          | s             |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%psmean               | cumulative_surface_pressure_multiplied_by_timestep                      | cumulative surface pressure multiplied by timestep              | Pa s          |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%psurf                | surface_air_pressure_diag                                               | surface air pressure diagnostic                                 | Pa            |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%ulwsfci              | surface_upwelling_longwave_flux                                         | surface upwelling longwave flux at current time                 | W m-2         |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%dswsfci              | surface_downwelling_shortwave_flux                                      | surface downwelling shortwave flux at current time              | W m-2         |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%nswsfci              | surface_net_downwelling_shortwave_flux                                  | surface net downwelling shortwave flux at current time          | W m-2         |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%uswsfci              | surface_upwelling_shortwave_flux                                        | surface upwelling shortwave flux at current time                | W m-2         |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%dusfci               | instantaneous_surface_x_momentum_flux_for_diag                          | instantaneous sfc x momentum flux multiplied by timestep        | Pa            |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%snowfallac           | total_accumulated_snowfall                                              | run-total snow accumulation on the ground                       | kg m-2        |    1 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%acsnow               | accumulated_water_equivalent_of_frozen_precip                           | snow water equivalent of run-total frozen precip                | kg m-2        |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%CLDFRA_BL            | subgrid_cloud_fraction_pbl                                                | subgrid cloud fraction from PBL scheme                                 | frac          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%QC_BL                | subgrid_cloud_mixing_ratio_pbl                                            | subgrid cloud cloud mixing ratio from PBL scheme                       | kg kg-1       |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%el_pbl               | mixing_length                                                             | mixing length in meters                                                | m             |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%Sh3D                 | stability_function_for_heat                                               | stability function for heat                                            | none          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%qke                  | tke_at_mass_points                                                        | 2 x tke at mass points                                                 | m2 s-2        |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%qke_adv              | tke_at_mass_points_advected                                               | 2 x tke at mass points advected                                        | m2 s-2        |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%tsq                  | t_prime_squared                                                           | temperature fluctuation squared                                        | K2            |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%qsq                  | q_prime_squared                                                           | water vapor fluctuation squared                                        | kg2 kg-2      |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%cov                  | t_prime_q_prime                                                           | covariance of temperature and moisture                                 | K kg kg-1     |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%edmf_a               | emdf_updraft_area                                                         | updraft area from mass flux scheme                                     | frac          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%edmf_w               | emdf_updraft_vertical_velocity                                            | updraft vertical velocity from mass flux scheme                        | m s-1         |    2 | real        | kind_phys | none   | F        |
!! | IPD_Data(nb)%Intdiag%edmf_qt              | emdf_updraft_total_water                                                  | updraft total water from mass flux scheme                              | kg kg-1       |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%cldtaulw                      | cloud_optical_depth_layers_at_10mu_band                                                        | approx 10mu band layer cloud optical depth                                          | none          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%cldtausw                      | cloud_optical_depth_layers_at_0.55mu_band                                                      | approx .55mu band layer cloud optical depth                                         | none          |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%clw(:,:,1)                    | ice_water_mixing_ratio_convective_transport_tracer                            | moist (dry+vapor, no condensates) mixing ratio of ice water in the convectively transported tracer array | kg kg-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%clw(:,:,2)                    | cloud_condensed_water_mixing_ratio_convective_transport_tracer | moist (dry+vapor, no condensates) mixing ratio of cloud water (condensate) in the convectively transported tracer array | kg kg-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%clw(:,:,IPD_Interstitial(nt)%ntk) | turbulent_kinetic_energy_convective_transport_tracer                                       | turbulent kinetic energy in the convectively transported tracer array               | m2 s-2        |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%ctei_r                        | cloud_top_entrainment_instability_value                                                        | cloud top entrainment instability value                                             | none          |    1 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ctei_rml                      | grid_sensitive_critical_cloud_top_entrainment_instability_criteria                             | grid sensitive critical cloud top entrainment instability criteria                  | none          |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%de_lgth                       | cloud_decorrelation_length                                                                     | cloud decorrelation length                                                          | km            |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%delr                          | layer_pressure_thickness_for_radiation                                                         | layer pressure thickness on radiation levels                                        | hPa           |    2 | real        | kind_phys | none   | F        | 
...
!! | IPD_Interstitial(nt)%dqdt                          | tendency_of_tracers_due_to_model_physics                                                       | updated tendency of the tracers due to model physics                                | kg kg-1 s-1   |    3 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,1)                   | tendency_of_water_vapor_specific_humidity_due_to_model_physics                                 | water vapor specific humidity tendency due to model physics                         | kg kg-1 s-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntcw)    | tendency_of_liquid_cloud_water_mixing_ratio_due_to_model_physics                               | cloud condensed water mixing ratio tendency due to model physics                    | kg kg-1 s-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntiw)    | tendency_of_ice_cloud_water_mixing_ratio_due_to_model_physics                                  | cloud condensed water mixing ratio tendency due to model physics                    | kg kg-1 s-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntoz)    | tendency_of_ozone_mixing_ratio_due_to_model_physics                                            | ozone mixing ratio tendency due to model physics                                    | kg kg-1 s-1   |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntlnc)   | tendency_of_cloud_droplet_number_concentration_due_to_model_physics                            | number concentration of cloud droplets (liquid) tendency due to model physics       | kg-1 s-1      |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntinc)   | tendency_of_ice_number_concentration_due_to_model_physics                                      | number concentration of ice tendency due to model physics                           | kg-1 s-1      |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntwa)    | tendency_of_water_friendly_aerosol_number_concentration_due_to_model_physics                   | number concentration of water-friendly aerosols tendency due to model physics       | kg-1 s-1      |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntia)    | tendency_of_ice_friendly_aerosol_number_concentration_due_to_model_physics                     | number concentration of ice-friendly aerosols tendency due to model physics         | kg-1 s-1      |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntrw)    | tendency_of_rain_water_mixing_ratio_due_to_model_physics                                       | moist (dry+vapor, no condensates) mixing ratio of rain water tendency due to model physics | kg kg-1 s-1   |    2 | real | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%dqdt(:,:,IPD_Control%ntke)    | tendency_of_turbulent_kinetic_energy_due_to_model_physics                                      | turbulent kinetic energy tendency due to model physics                              | J s-1         |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%dvdftra                       | tendency_of_vertically_diffused_tracer_concentration                                           | updated tendency of the tracers due to vertical diffusion in PBL scheme             | kg kg-1 s-1   |    3 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%dzlyr                         | layer_thickness_for_radiation                                                                  | layer thickness on radiation levels                                                 | km            |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%flag_cice                     | flag_for_cice                                                                                  | flag for cice                                                                       | flag          |    1 | logical     |           | none   | F        |
...
!! | IPD_Interstitial(nt)%im                            | horizontal_loop_extent_OLD_NOW_MODEL_PERCENT_BLKSZ_OF_NB                                       | horizontal loop extent                                                              | count         |    0 | integer     |           | none   | F        |
...
!! | IPD_Interstitial(nt)%ix                            | horizontal_dimension_OLD_NOW_MODEL_PERCENT_BLKSZ_OF_NB                                         | horizontal dimension                                                                | count         |    0 | integer     |           | none   | F        |
...
!! | IPD_Interstitial(nt)%ncgl                          | local_graupel_number_concentration                                                             | number concentration of graupel local to physics                                    | kg-1          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ncpi                          | local_ice_number_concentration                                                                 | number concentration of ice local to physics                                        | kg-1          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ncpl                          | local_condesed_water_number_concentration                                                      | number concentration of condensed water local to physics                            | kg-1          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ncpr                          | local_rain_number_concentration                                                                | number concentration of rain local to physics                                       | kg-1          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ncps                          | local_snow_number_concentration                                                                | number concentration of snow local to physics                                       | kg-1          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%ntiwx                         | index_for_ntiwx_dh_todo_find_better_name                                                       | index for ntiwx DH* todo find better name                                           | index         |    0 | integer     |           | none   | F        |
!! | IPD_Interstitial(nt)%ntk                           | index_for_turbulent_kinetic_energy_convective_transport_tracer                                 | index for turbulent kinetic energy in the convectively transported tracer array     | index         |    0 | integer     |           | none   | F        |
!! | IPD_Interstitial(nt)%ntkev                         | index_for_turbulent_kinetic_energy_vertical_diffusion_tracer                                   | index for turbulent kinetic energy in the vertically diffused tracer array          | index         |    0 | integer     |           | none   | F        |
...
!! | IPD_Interstitial(nt)%prnum                         | prandtl_number                                                                                 | turbulent Prandtl number                                                            | none          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%qgl                           | local_graupel_mixing_ratio                                                                     | moist (dry+vapor, no condensates) mixing ratio of graupel local to physics          | kg kg-1       |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%qicn                          | mass_fraction_of_convective_cloud_ice                                                          | mass fraction of convective cloud ice water                                         | kg kg-1       |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%qlcn                          | mass_fraction_of_convective_cloud_liquid_water                                                 | mass fraction of convective cloud liquid water                                      | kg kg-1       |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%qrn                           | local_rain_water_mixing_ratio                                                                  | moist (dry+vapor, no condensates) mixing ratio of rain water local to physics       | kg kg-1       |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%qsnw                          | local_snow_water_mixing_ratio                                                                  | moist (dry+vapor, no condensates) mixing ratio of snow water local to physics       | kg kg-1       |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%save_q(:,:,IPD_Control%ntcw)  | cloud_condensed_water_mixing_ratio_save                                | moist (dry+vapor, no condensates) mixing ratio of cloud water (condensate) before entering a physics scheme | kg kg-1       |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%save_q(:,:,IPD_Control%ntiw)  | ice_water_mixing_ratio_save                                                                    | cloud ice water mixing ratio before entering a physics scheme                       | kg kg-1       |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%sigmafrac                     | convective_updraft_area_fraction                                                               | convective updraft area fraction                                                    | frac          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%sigmatot                      | convective_updraft_area_fraction_at_model_interfaces                                           | convective updraft area fraction at model interfaces                                | frac          |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%skip_macro                    | flag_skip_macro                                                                                | flag to skip cloud macrophysics in Morrison scheme                                  | flag          |    0 | logical     |           | none   | F        |
...
!! | IPD_Interstitial(nt)%ulwsfc_cice                   | surface_upwelling_longwave_flux_for_cice                                                       | surface upwelling longwave flux for cice                                            | W m-2         |    1 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%w_upi                         | vertical_velocity_for_updraft                                                                  | vertical velocity for updraft                                                       | m s-1         |    2 | real        | kind_phys | none   | F        |
!! | IPD_Interstitial(nt)%wcbmax                        | maximum_updraft_velocity_at_cloud_base                                                         | maximum updraft velocity at cloud base                                              | m s-1         |    1 | real        | kind_phys | none   | F        |
    ...
    if (Model%me == Model%master) then
      ...
      if (Model%do_deep) then
#ifdef CCPP
        ! Consistency check for GF or NTDK convection: deep and shallow convection are bundled
        ...
        if ( (Model%imfdeepcnv == 3 .or. Model%imfshalcnv == 3) .and. &
            ...
            write(0,*) "Logic error: if GF or NTDK deep convection is used, must also use GF shallow convection (and vice versa)"
            stop
        end if

#else
        if (Model%imfdeepcnv == 3 .or. Model%imfshalcnv == 3) then
            write(0,*) "Error, GF and NTDK convection scheme only available through CCPP"
            stop
        end if
        ...
        if (.not. Model%cscnv) then
          if (Model%ras) then
            ...
            elseif(Model%imfdeepcnv == 3) then
               print *,'Grell-Freitas scale & aerosol-aware mass-flux deep conv scheme or New Tiedtke cumulus scheme'
            endif
          endif
        else
          if (Model%do_aw) then
     ...
     &,                ' unified parameterization used'
      ...
      if (.not. Model%shal_cnv) then
        ...
        elseif (Model%imfshalcnv == 3) then
          print *,'Grell-Freitas scale- & aerosol-aware mass-flux shallow conv scheme (2013) or New Tiedtke cumulus scheme'
        else
...
!--- needed to allocate GoCart coupling fields
    ...
    if (Model%do_mynnedmf) then
      ...
      allocate (Diag%sh3d      (IM,Model%levs))
      allocate (Diag%qke       (IM,Model%levs))
      allocate (Diag%qke_adv   (IM,Model%levs))
      allocate (Diag%tsq       (IM,Model%levs))
      allocate (Diag%qsq       (IM,Model%levs))
      allocate (Diag%cov       (IM,Model%levs))
