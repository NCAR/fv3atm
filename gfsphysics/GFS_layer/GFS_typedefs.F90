...
!! | IPD_Control%ntke                     | index_for_turbulence_kinetic_energy                                           | tracer index for turbulence kinetic energy                           | index         |    0 | integer   |           | none   | F        |
...
!! | IPD_Data(nb)%Intdiag%QC_BL                | subgrid_cloud_mixing ratio_pbl                                            | subgrid cloud cloud mixing ratio from PBL scheme                       | kg kg-1       |    2 | real        | kind_phys | none   | F        |
...
!! | IPD_Interstitial(nt)%ntkev                         | index_of_TKE_vertical_diffusion_tracer                                                         | index of TKE in the vertically diffused tracer array                                | index         |    0 | integer     |           | none   | F        |
