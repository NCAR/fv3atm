...
!! | GFS_Control%blksz(nb)                | horizontal_loop_extent                                                        | horizontal loop extent (previously Interstitial(nt)%im) | count         |    0 | integer   |           | none   | F        |
!! | GFS_Control%blksz(nb)                | horizontal_dimension                                                          | horizontal dimension (previously Interstitial(nt)%ix)   | count         |    0 | integer   |           | none   | F        |
