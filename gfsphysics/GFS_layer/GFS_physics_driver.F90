...
#else
            if (Model%me==0) write(0,*) 'Error, GF convection scheme only available through CCPP'
#endif
...
#ifdef CCPP
! DH* fix indents, move further up? match SDF
! needs a test if GF is actually called or not
