...
!! | Atm(mytile)%delp                   | pressure_thickness_at_Lagrangian_surface                      | pressure thickness at Lagrangian surface                                               | Pa        |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%delz                   | thickness_at_Lagrangian_surface                               | thickness at Lagrangian_surface                                                        | m         |    3 | real      | kind_dyn  | none   | F        |
...
!! | Atm(mytile)%peln                   | log_pressure_at_Lagrangian_surface                            | logarithm of pressure at Lagrangian surface                                            | Pa        |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%phis                   | surface_geopotential_at_Lagrangian_surface                    | surface geopotential at Lagrangian surface                                             | m2 s-2    |    2 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%pkz                    | finite-volume_mean_edge_pressure_raised_to_the_power_of_kappa | finite-volume mean edge pressure raised to the power of kappa                          | Pa**kappa |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%pt                     | virtual_temperature_at_Lagrangian_surface                     | virtual temperature at Lagrangian surface                                              | K         |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,sphum)         | water_vapor_specific_humidity_at_Lagrangian_surface           | water vapor specific humidity updated by fast physics at Lagrangian surface            | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,liq_wat)       | cloud_liquid_water_specific_humidity_at_Lagrangian_surface    | cloud liquid water specific humidity updated by fast physics at Lagrangian surface     | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,ice_wat)       | cloud_ice_specific_humidity_at_Lagrangian_surface             | cloud ice specific humidity updated by fast physics at Lagrangian surface              | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,rainwat)       | cloud_rain_specific_humidity_at_Lagrangian_surface            | cloud rain specific humidity updated by fast physics at Lagrangian surface             | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,snowwat)       | cloud_snow_specific_humidity_at_Lagrangian_surface            | cloud snow specific humidity updated by fast physics at Lagrangian surface             | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,graupel)       | cloud_graupel_specific_humidity_at_Lagrangian_surface         | cloud graupel specific humidity updated by fast physics at Lagrangian surface          | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q(:,:,:,cld_amt)       | cloud_fraction_at_Lagrangian_surface                          | cloud fraction at Lagrangian surface                                                   | none      |    3 | real      | kind_dyn  | none   | F        |
!! | Atm(mytile)%q_con                  | cloud_condensed_water_specific_humidity_at_Lagrangian_surface | cloud condensed water specific humidity updated by fast physics at Lagrangian surface  | kg kg-1   |    3 | real      | kind_dyn  | none   | F        |
!!
#endif
  type fv_atmos_type
